...
- Filename-based indexing for 874 normalized records across 507 unique MP3 files.
...
- Dark practice UI with section navigation, series selection, persistent answer feedback, difficulty-ranked question groups, audio ranges and speed controls.
...
- The generated catalog currently exposes 360 reviewed records: 205 listening, 70 grammar, and 85 reading questions.
